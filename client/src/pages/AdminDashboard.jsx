...
/* ---- Report Submission Area Chart (Recharts) ---- */
const ReportSubmissionChart = ({ reportData, activeFilter, setActiveFilter }) => {
  ...
  // Transform for Recharts: array of { day, Computer, IT, EXTC }
...
/* ---- Internship Status Radial Chart (Recharts) ---- */
                  ...
                  {filteredStudents.map((s) => (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-3">
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${statusClasses(s.status)}`}>
                          {s.status}
                        </span>
                      </td>
