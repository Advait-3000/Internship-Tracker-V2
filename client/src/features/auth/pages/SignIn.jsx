      ...
      <div className="flex flex-col lg:flex-row w-full max-w-6xl bg-white rounded-[32px] shadow-sm overflow-hidden">
        ...
        <div className="flex w-full lg:w-1/2 p-4 mt-8 lg:mt-0">
          <div className="w-full h-full rounded-[24px] bg-[#1E2047] bg-gradient-to-br from-[#1E2047] via-[#2F2150] to-[#E98292] relative overflow-hidden flex flex-col justify-center items-center py-12 lg:py-0">
            ...
            <div className="z-10 w-full max-w-md px-8 text-center relative h-[380px]">
              <div className="flex items-center justify-between mb-8">
                 <h2 className="text-3xl font-bold text-white text-left">New Features</h2>
              ...
              <div className="relative w-full h-[250px]">
                {dashboardSlides.map((slide, slideIdx) => (
                  ...
                  >
                    {/* First Card */}
                    <div className="bg-white rounded-2xl p-4 shadow-lg text-left h-[110px]">
                    ...
                    {/* Third Card */}
                    <div className="bg-white rounded-2xl p-4 shadow-lg text-left col-span-1 h-[110px]">
                      <div className="flex justify-between items-start mb-2">
              ...
              {/* Pagination Dots */}
              <div className="absolute bottom-0 left-0 w-full flex justify-center mt-8 space-x-2 px-4">
